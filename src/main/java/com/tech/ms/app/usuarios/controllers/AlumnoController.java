...
import com.tech.ms.app.commons.controllers.CommonController;
import com.tech.ms.app.usuarios.services.AlumnoService;
...
public class AlumnoController extends CommonController<Alumno, AlumnoService>  {
	...
	@GetMapping("/filtrar/{parametro}")
	public ResponseEntity<?> filtrar(@PathVariable String parametro){
		return ResponseEntity.ok(service.findByNombreOrApellido(parametro));
	}
